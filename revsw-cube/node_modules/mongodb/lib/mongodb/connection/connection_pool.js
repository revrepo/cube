...
var ConnectionPool = exports.ConnectionPool = function(host, port, poolSize, bson, socketOptions) {
  if(typeof host !== 'string') {
    revlogger.log('alert',"host must be specified [" + host + "]");
  ...
  if(host.match(/^\//)) {
    ...
    try { 
      ...
      revlogger.log('alert',"port must be specified or valid integer["  + port + "]");
      new Error("port must be specified or valid integer["  + port + "]"); 
    }
  } else if(typeof port !== 'number') {
    revlogger.log('alert',"port must be specified ["  + port + "]");
